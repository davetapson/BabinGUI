...
namespace IBClient
{
    ...
    public class EWrapperImpl : EWrapper 
    {
        ...
        public virtual void error(string errorString)
        {
            ...
            Error error = new Error(0, 0, errorString);
        ...
        public virtual void error(int id, int errorCode, string errorMsg)
        {
            ...
            Error error = new Error(id, errorCode, errorMsg);
        ...
        public virtual void updateAccountValue(string key, string value, string currency, string accountName)
        {
            ...
            AccountValue accountValue = new AccountValue(key, value, currency, accountName);

            RaiseAccountValueUpdatedEvent(new AccountValueArgs(accountValue));
        }
